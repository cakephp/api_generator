<ul class="navigation">
	<li><?php
		...
		echo $this->Html->link(__d('api_generator', 'Classes', true), array(
	...
	<li><?php
		...
		echo $this->Html->link(__d('api_generator', 'Source', true), array(
			'plugin' => 'api_generator',
	...
	<li><?php
		...
		echo $this->Html->link(__d('api_generator', 'Files', true), array(
			'plugin' => 'api_generator',
	...
	<li><?php
		...
		echo $this->Html->link(__d('api_generator', 'Packages', true), array(
			'plugin' => 'api_generator',
