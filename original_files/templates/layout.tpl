...
<head>
	...
	<title>Bones : {$doc.classInfo.name} Documentation</title>
	<link href="{$smarty.const.WEB_ROOT}sys/css/base.css" rel="stylesheet" media="screen" />
	<script src="{$smarty.const.WEB_ROOT}sys/js/mootools.js" type="text/javascript"></script>
	<script src="{$smarty.const.WEB_ROOT}sys/js/bones.js" type="text/javascript"></script>
</head>
<div id="wrapper">
	<div id="header">
		<div id="sub-header">
			<h1>{$doc.classInfo.name}</h1>
			<h2></h2>
		</div>
	</div>
